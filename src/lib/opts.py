...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='gas',################################################################
                             help='coco | kitti | coco_hp | pascal | smoke | gas')
    self.parser.add_argument('--exp_id', default='dla34-mod')
    ...
    # train
    self.parser.add_argument('--lr', type=float, default=1.25e-4, #1.25e-4
                             help='learning rate for batch size 32.')
    self.parser.add_argument('--lr_step', type=str, default='20,40,60,80',#20,40,60#####################################
